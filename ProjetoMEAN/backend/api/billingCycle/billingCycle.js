...
const debtSchema = new mongoose.Schema({
  ...
  value: { type: Number, min: 0, required: [true, 'Informe o valor do débito!'] }, //Mensagem de erro particular para o required
...
const billingCycleSchema = new mongoose.Schema({
  ...
  year: { type: Number, min: 1970, max: 2100, required: [true, 'Informe o valor do ano'] },
